...
export async function create(req, res, next) {
  try {
    const { name, adminName, adminEmail, adminPassword, initialUserLimit, status, organizationId } = req.body;
    ...
    const created = await CompanyService.createCompanyWithAdmin({
      name,
      adminName,
      adminEmail,
      adminPassword,
